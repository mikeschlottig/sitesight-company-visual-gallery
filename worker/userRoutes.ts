...
const mockCompanies: Company[] = [
  ...
  { id: '5', name: 'Vercel', domain: 'vercel.com', description: 'Vercel is the platform for frontend developers, providing the speed and reliability innovators need to create at the moment of inspiration.', tags: ['PaaS', 'Developer Tools', 'Next.js'], lastUpdated: '2024-07-21', techStack: ['Next.js', 'Go', 'Rust'] },
  ...
  { id: '7', name: 'Figma', domain: 'figma.com', description: 'The collaborative interface design tool.', tags: ['Design', 'SaaS', 'Collaboration'], lastUpdated: '2024-07-18', techStack: ['React', 'TypeScript', 'WebAssembly'] },
  ...
  { id: '9', name: 'Linear', domain: 'linear.app', description: 'The issue tracking tool you\'ll enjoy using.', tags: ['Project Management', 'SaaS', 'Developer Tools'], lastUpdated: '2024-07-22', techStack: ['React', 'TypeScript', 'GraphQL'] },
  ...
  { id: '11', name: 'Retool', domain: 'retool.com', description: 'The fast way to build internal tools.', tags: ['Internal Tools', 'SaaS', 'Low-code'], lastUpdated: '2024-07-19', techStack: ['React', 'Node.js', 'PostgreSQL'] },
  ...
  { id: '13', name: 'PlanetScale', domain: 'planetscale.com', description: 'The database for developers.', tags: ['Database', 'SaaS', 'MySQL'], lastUpdated: '2024-07-20', techStack: ['Go', 'Vitess', 'React'] },
  ...
  { id: '15', name: 'Fly.io', domain: 'fly.io', description: 'Run your full stack apps (and databases!) all over the world.', tags: ['PaaS', 'Hosting', 'Edge'], lastUpdated: '2024-07-22', techStack: ['Go', 'Rust', 'Elixir'] },
  ...
  { id: '19', name: 'PostHog', domain: 'posthog.com', description: 'The open source product analytics suite.', tags: ['Analytics', 'Open Source', 'SaaS'], lastUpdated: '2024-07-18', techStack: ['Python', 'ClickHouse', 'React'] },
